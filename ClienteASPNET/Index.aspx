<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="ClienteASPNET.Index" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <p>
                <asp:Label ID="Label1" runat="server" Font-Size="XX-Large" ForeColor="Red" Text="Listado Ciudadano"></asp:Label>
            </p>
            <p>
